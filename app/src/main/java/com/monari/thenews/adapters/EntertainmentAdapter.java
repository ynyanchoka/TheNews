...
public class EntertainmentAdapter extends RecyclerView.Adapter<EntertainmentAdapter.EntertainmentViewHolder>{
    ...
    public EntertainmentAdapter(Context context, List<Article> articles) {
        mContext = context;
        mNews = articles;
    }
    ...
    public EntertainmentAdapter.EntertainmentViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        EntertainmentAdapter.EntertainmentViewHolder viewHolder = new EntertainmentAdapter.EntertainmentViewHolder(view);
        return viewHolder;
    }


    @Override
    public void onBindViewHolder(EntertainmentAdapter.EntertainmentViewHolder holder, int position) {
