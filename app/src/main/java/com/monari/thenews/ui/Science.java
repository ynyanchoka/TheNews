...
public class Science extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b2.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent intent = new Intent(Science.this, BusinessActivity.class);
                startActivity(intent);
        ...
        b3.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent intent = new Intent(Science.this, EntertainmentActivity.class);
                startActivity(intent);
        ...
        b4.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent intent = new Intent(Science.this, HealthActivity.class);
                startActivity(intent);
        ...
        b6.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent intent = new Intent(Science.this, SportsActivity.class);
                startActivity(intent);
...
//        });
        ...
        retrofit2.Call<NewsSearchResponse> call = newsApi.getNews("us","science", BuildConfig.NEWS_API_KEY);
        ...
        call.enqueue(new retrofit2.Callback<NewsSearchResponse>() {
            ...
            public void onResponse(retrofit2.Call<NewsSearchResponse> call, retrofit2.Response<NewsSearchResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    mAdapter = new NewsListAdapter(Science.this, articles);
                    mRecyclerView.setAdapter(mAdapter);
                    RecyclerView.LayoutManager layoutManager =
                            new LinearLayoutManager(Science.this);
